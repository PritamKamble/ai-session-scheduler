    ...
    useEffect(() => {
        const loadConversation = () => {
            try {
                ...
                if (savedTimestamp && currentTime - parseInt(savedTimestamp) > CONVERSATION_EXPIRATION) {
        ...
        const syncUser = async () => {
            if (isLoaded && isSignedIn && user) {
                try {
                    ...
                    const userRole = teacherEmails.includes(user.primaryEmailAddress?.emailAddress)
                        ? 'teacher'
                        : 'student'
