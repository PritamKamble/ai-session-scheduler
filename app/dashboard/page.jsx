              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="relative w-full max-w-3xl mx-auto">
                      ...
                      <Input
                        ...
                        placeholder={
                          role === "teacher"
                            ...
                            : "E.g., 'I want to learn Python and I'm available weekdays after 5pm'"
                        }
                        value={userInput}
                  ...
                  <p className="text-xs text-muted-foreground text-center mt-2">
                    {role === "teacher"
                      ? "Describe your availability and expertise"
                      : "Tell us what you want to learn and when you're available"}
                  </p>
                </div>
              </div>
            </div>
